...
extern struct St_var* VS_create_new_var(BText, BText, BInt4, BInt4, BInt4[], BInt4, BInt4[]);
extern size_t VS_calc_number_of_values(struct St_var*);
...
extern size_t VS_calc_number_of_values() extern struct St_var* VS_read_var_from_pipe();
