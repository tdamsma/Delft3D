...
extern BInt4 VR_read_var_from_file(const BText, const BText, const BText, BInt4[][3], BInt4[][3]);
extern BVoid PR_variables_info_print(BVoid);
extern BVoid PR_print_variable_info(FILE*, struct St_var*);
...
extern BInt4 VR_same_structure(struct St_var*, struct St_var*);
