...
extern BInt4 Crenef(BInt4*, BText, BText, BChar, BChar);
extern BInt4 Defcel(BInt4*, BText, BInt4, BChar[][MAX_NAME + 1]);
extern BInt4 Defelm(BInt4*, BText, BText, BInt4, BText, BText, BText, BInt4, BInt4*);
extern BInt4 Defgrp(BInt4*, BText, BText, BInt4, BInt4*, BInt4*);
extern BInt4 Flsdat(BInt4*);
extern BInt4 Flsdef(BInt4*);
extern BInt4 Getelt(BInt4*, BText, BText, BInt4[][DEFINE_STEPS], BInt4*, BInt4*, BData);
extern BInt4 Inqcel(BInt4*, BText, BInt4*, BChar[][MAX_NAME + 1]);
extern BInt4 Inqdat(BInt4*, BText, BText);
extern BInt4 Inqelm(BInt4*, BText, BText, BInt4*, BText, BText, BText, BInt4*, BInt4*);
extern BInt4 Inqfcl(BInt4*, BText, BInt4*, BInt4*, BChar[][MAX_NAME + 1]);
extern BInt4 Inqncl(BInt4*, BText, BInt4*, BInt4*, BChar[][MAX_NAME + 1]);
extern BInt4 Inqfel(BInt4*, BText, BText, BText, BText, BText, BInt4*, BInt4*, BInt4*, BInt4*);
extern BInt4 Inqnel(BInt4*, BText, BText, BText, BText, BText, BInt4*, BInt4*, BInt4*, BInt4*);
...
extern BInt4 Putelt(BInt4*, BText, BText, BInt4[][DEFINE_STEPS], BInt4*, BData);
