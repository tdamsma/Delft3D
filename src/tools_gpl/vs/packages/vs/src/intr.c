...
#define AVGFUNC(typeid, type)                                                                        \
    static BInt2 avg##typeid(const VsVarData p, const BInt4 n, const BRea8* excl_val, BRea8* retval) \
    {                                                                                                \
        BInt4 i;                                                                                     \
        BInt4 ntot;                                                                                  \
        BRea8 sum;                                                                                   \
...
#define MAXFUNC(typeid, type)                                                                        \
    static BInt2 max##typeid(const VsVarData p, const BInt4 n, const BRea8* excl_val, BRea8* retval) \
    {                                                                                                \
        BInt4 i;                                                                                     \
        BRea8 max;                                                                                   \
        type* varpnt;                                                                                \
...
#define MINFUNC(typeid, type)                                                                        \
    static BInt2 min##typeid(const VsVarData p, const BInt4 n, const BRea8* excl_val, BRea8* retval) \
    {                                                                                                \
        BInt4 i;                                                                                     \
        BRea8 min;                                                                                   \
        type* varpnt;                                                                                \
...
/* This is a dummy function to catch intrinsics
   on chars, bools, etc. */
static BInt2 intr_error(const VsVarData p1, const BInt4 n, const BRea8* dum1, BRea8* dum2)
{
 ...
 */
void FU_intrinsic(BInt2 which,          /* range: INTR_TYPE (see gen.h) */
...
)
{
    ...
    static BInt2 (*intrfunc[3][9])(const VsVarData, BInt4, const BRea8*, BRea8*) = {
        intr_error, intr_error, avgDOUBLE, avgFLOAT, avgINT, avgSHORT, intr_error, intr_error, intr_error,
        intr_error, intr_error, maxDOUBLE, maxFLOAT, maxINT, maxSHORT, intr_error, intr_error, intr_error,
        intr_error, intr_error, minDOUBLE, minFLOAT, minINT, minSHORT, intr_error, intr_error, intr_error};
    static BText elmnam[] = {"--Average--", "--Maximum--", "--Minimum--"};
    BInt2 retcod;
    BRea8 retval;
    VsVarData pa;
    VsVarData pn;
    ...
    retcod = (*intrfunc[which][VR_get_data_type(pa)])(pa, PP_calc_number_of_variables(pa), excl_val, &retval);
