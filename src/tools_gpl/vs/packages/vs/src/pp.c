...
/*  @@
 */
VsVarData PP_create_new_var(BText varnam, BText elmtyp, BInt4 nbytsg, BInt4 grpndm, BInt4 grpdms[], BInt4 elmndm,
                            BInt4 elmdms[])
{
    VsVarData p;
...
/*  @@
 */
BVoid PP_write_var_to_pipe(FILE* file, VsVarData p)
{
    BInt4 nbytes;
