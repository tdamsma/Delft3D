...
public:
    ...
    double operator()(double dG) { return w->fGS_dG(dG) - rhs; }
...
void WALRUS::init(double starttime, double Q0, double hS0, double dG0, double dV0, double hQ0, double Gfrac)
{
...
void WALRUS::init_by_all(double starttime, double Q0, double hS0, double dG0, double dV0, double hQ0, double Gfrac)
{
    init(starttime, Q0, hS0, dG0, dV0, hQ0, Gfrac);
}
// the simpliest initialization
void WALRUS::init_by_Q(double Q0) { init(0.0, Q0, NAN, NAN, NAN, NAN, 1.0); }
void WALRUS::init(double Q0) { init(0.0, Q0, NAN, NAN, NAN, NAN, 1.0); }

void WALRUS::init_by_tQ(double starttime, double Q0) { init(starttime, Q0, NAN, NAN, NAN, NAN, 1.0); }
void WALRUS::init(double starttime, double Q0) { init(starttime, Q0, NAN, NAN, NAN, NAN, 1.0); }

void WALRUS::init_by_Qstates(double Q0, double hS0, double dG0, double dV0, double hQ0)
{
    init(0.0, Q0, hS0, dG0, dV0, hQ0, 1.0);
}
void WALRUS::init(double Q0, double hS0, double dG0, double dV0, double hQ0) { init(0.0, Q0, hS0, dG0, dV0, hQ0, 1.0); }
...
void WALRUS::init(double starttime, double Q0, double hS0, double dG0, double dV0, double hQ0)
{
    init(starttime, Q0, hS0, dG0, dV0, hQ0, 1.0);
}
