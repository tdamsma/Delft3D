...
int WALRUSSETSEQC(int* walrusInstanceIndex, int* varEnum, void* times, int* timesLenght, void* fc_vec,
                  int* fc_vecLenght, double* timestepsize, int* startIndex)
{
    try
    {
...
int WALRUSINIT(int* walrusInstanceIndex, double* StartTime, double* Q0, double* hS0, double* dG0, double* dV0,
               double* hQ0, double* Gfrac, int* startIndex)
{
    try
    {
        int walrusInstance = *walrusInstanceIndex;
...
int WALRUSSETWDVBYTABLE(int* walrusInstanceIndex, void* times, int* timesLenght, void* fc_vec, int* fc_vecLenght,
                        int* startIndex)
{
    try
    {
...
int WALRUSSETDVEQDGBYTABLE(int* walrusInstanceIndex, void* times, int* timesLenght, void* fc_vec, int* fc_vecLenght,
                           int* startIndex)
{
    try
    {
...
int WALRUSSETBETADVBYTABLE(int* walrusInstanceIndex, void* times, int* timesLenght, void* fc_vec, int* fc_vecLenght,
                           int* startIndex)
{
    try
    {
...
int WALRUSSETQHSBYTABLE(int* walrusInstanceIndex, void* times, int* timesLenght, void* fc_vec, int* fc_vecLenght,
                        int* startIndex)
{
    try
    {
