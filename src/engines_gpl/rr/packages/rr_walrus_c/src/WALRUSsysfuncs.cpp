...
void WALRUS::set_W_dV_bytable(const std::vector<double>& dV, const std::vector<double>& W)
{
...
double WALRUS::dVeq_dG(double dG)
{
    if (dVeq_dG_analytical)
    {
        if (dG > psi_ae)
        {
            ...
            return (dG - psi_ae / (1 - b) - dG * dummy + dG / (1 - b) * dummy) * theta_s;
        }
        else if (dG < 0)
        {
            return dG;
...
void WALRUS::set_dVeq_dG_bytable(const std::vector<double>& dG, const std::vector<double>& dVeq)
{
...
void WALRUS::set_beta_dV_bytable(const std::vector<double>& dV, const std::vector<double>& beta)
{
...
void WALRUS::set_Q_hS_bytable(const std::vector<double>& hS, const std::vector<double>& Q)
{
