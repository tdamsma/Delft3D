...
void WALRUS::set_I(unsigned int idnum, double intensity) { set_I((WALRUS_FORCING)idnum, intensity); }
...
void WALRUS::set_seq_Cbyname(const char* name, const std::vector<double> times, const std::vector<double> fc_vec)
{
...
void WALRUS::set_seq_C(unsigned int idnum, const std::vector<double> times, const std::vector<double> fc_vec,
                       double timestepsize)
{
    set_seq_C((WALRUS_FORCING)idnum, times, fc_vec, timestepsize);
}

void WALRUS::set_seq_C(enum WALRUS_FORCING fc, const std::vector<double> times, const std::vector<double> fcvec,
                       double timestepsize)
{
...
void WALRUS::set_seq_Ibyname(const char* name, double tstart, double timestep, const std::vector<double> fc_vec)
{
    if (strcmp(name, "fc_P") == 0)
    {
...
void WALRUS::set_seq_I(unsigned int idnum, double tstart, double timestep, const std::vector<double> fc_vec)
{
    set_seq_I((WALRUS_FORCING)idnum, tstart, timestep, fc_vec);
}

void WALRUS::set_seq_I(enum WALRUS_FORCING fc, double tstart, double timestep, const std::vector<double> fcvec)
{
...
double WALRUS::get_cum(enum WALRUS_FORCING fc, double from_time, double to_time)
{
    switch (fc)
    {
        case fc_P:
