...
extern "C" {
/*
 * OPEN_SHARED_LIBRARY and CLOSE_SHARED_LIBRARY are used from
 * utils_lgpl\deltares_common\packages\deltares_common_c\src\shared_library_fortran_api.c
 */
#if defined(WIN32)
...
long STDCALL PERFORM_FUNCTION(long* sharedDLLHandle, char* function, float* pmsa, float* fl, long* ipoint, long* increm,
                              ...
                              long* noq4, long length_function)
#endif
{
    int error = 1;
    typedef void*(STDCALL * MyProc)(float*, float*, long*, long*, long*, long*, long*, long*, long*, long*, long*,
                                    long*);
    MyProc proc;
    char* fun_name;
    ...
    if (sharedDLL != NULL)
    {
        ...
        {
            error = 0;
            (void*)(*proc)(pmsa, fl, ipoint, increm, noseg, noflux, iexpnt, iknmrk, noq1, noq2, noq3, noq4);
        }
        free(fun_name);
        fun_name = NULL;
    }
