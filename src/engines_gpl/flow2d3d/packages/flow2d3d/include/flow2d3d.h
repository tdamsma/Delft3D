...
// $HeadURL:
// https://svn.oss.deltares.nl/repos/delft3d/branches/research/Deltares/20110420_OnlineVisualisation/src/engines_gpl/flow2d3d/packages/flow2d3d/include/flow2d3d.h
// $
//------------------------------------------------------------------------------
...
extern "C" {
void STDCALL TRISIM(int* numSubdomains, int* numMappers, int* contextID, int* fsmFlags, const char* runID,
                    int* initOnly, void* gdp, size_t runIDLen);
}

extern "C" {
void STDCALL TRISIM_UPDATE(double tstart, void* gdp);
}

extern "C" {
void STDCALL TRISIM_FINALIZE(void* gdp);
}

extern "C" {
void STDCALL TRISIM_GET_START_TIME(double* tstart, void* gdp);
}

extern "C" {
void STDCALL TRISIM_GET_END_TIME(double* tend, void* gdp);
}

extern "C" {
void STDCALL TRISIM_GET_TIME_STEP(double* tstep, void* gdp);
}

extern "C" {
void STDCALL TRISIM_GET_CURRENT_TIME(double* tcurrent, void* gdp);
}

extern "C" {
void STDCALL TRISIM_GET_VAR(const char* key, void* ref, void* gdp);
}
...
extern "C" {
DllExport bool DeltaresHydroEntry(DeltaresHydro* DHI);
}
...
{
public:
    Flow2D3D(DeltaresHydro* DHI);

    Flow2D3D(DeltaresHydro* DHI, char* configfile);
