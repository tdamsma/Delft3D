...
// $HeadURL:
// https://svn.oss.deltares.nl/repos/delft3d/branches/research/Deltares/20110420_OnlineVisualisation/src/engines_gpl/flow2d3d/packages/flow2d3d/src/dd/iterators/gawsbarrier.cpp
// $
//------------------------------------------------------------------------------
...
void GawsBarrier_Function(Iterator* self, const char* name, Blob* configblob)
{
    ...
    if (numD3dFlowProcesses > MAX_NUM_D3D_FLOW_PROCS) throw new Exception("GAWS barrier has too many participants");
