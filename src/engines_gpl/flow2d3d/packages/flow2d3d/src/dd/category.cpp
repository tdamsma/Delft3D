...
// $HeadURL:
// https://svn.oss.deltares.nl/repos/delft3d/branches/research/Deltares/20110420_OnlineVisualisation/src/engines_gpl/flow2d3d/packages/flow2d3d/src/dd/category.cpp
// $
//------------------------------------------------------------------------------
...
Category::Category(DD* dd, const char* name)
{
    // Validate constructor arguments

    if (name == NULL || name[0] == '\0') throw new Exception("Category does not have a name");
    if (strlen(name) >= DD::MAXSTRING) throw new Exception("Category name is too long");
...
Category::~Category(void) { delete[] this->name; }
