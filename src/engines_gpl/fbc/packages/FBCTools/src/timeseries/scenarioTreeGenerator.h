...
namespace rtctools
{
    namespace timeseries
    {
        ...
        public:
            ...
            void reduction(int nStep, vector<vector<double>> ensemble, vector<double>& p, vector<vector<int>>& direct,
                           int s);
            void average(timeSeriesTensorInterface* tsTensor, vector<vector<int>>& direct, vector<double>& p, int in,
                         int out);
