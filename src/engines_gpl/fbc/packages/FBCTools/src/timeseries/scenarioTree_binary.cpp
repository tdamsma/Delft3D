...
scenarioTree_binary::scenarioTree_binary(int iReference, vector<int> iInput, vector<int> iOutput, int iProbability,
                                         scenarioTree_binary::PARAMETER par)
...
void scenarioTree_binary::branchSet::split(int nReduction, vector<vector<double>>& ensemble,
                                           vector<vector<int>>& direct, int iStart)
{
