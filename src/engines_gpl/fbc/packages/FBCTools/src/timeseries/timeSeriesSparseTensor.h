...
namespace rtctools
{
    namespace timeseries
    {
        ...
        public:
             ...
             *
             */
            timeSeriesSparseTensor(
                int nEnsemble,                           ///< number of ensembles
             ...
             *
             * @return value at specified indices, inter- or extrapolated from values as stored in
             * timeSeriesSparseTensor
             */
            ...
            void setSeries(int ensembleId,           ///< ensemble index
                           int sIndex,               ///< series index
                           vector<long long>* times, ///< sparse time vector; setSeries will make a copy of the vector
                                                     ///< and will not take ownership of the original vector
                           vector<double>* vals, ///< sparse value vector; setSeries will make a copy of the vector and
                                                 ///< will not take ownership of the original vector
