 ...
 */
pidControllerPositional::pidControllerPositional(string id, string name, double kp, double ki, double kd, double kf,
...
pidControllerPositional::pidControllerPositional(string id, string name, double kp, double ki, double kd, double kf,
                                                 double settingMin, double settingMax, double settingMaxSpeed, int iXIn,
                                                 double SPIn, int iFIn, int iYOut, int iIOut, int iDOut, int numSeries)
    : rule(id, name)
{
    this->kp = kp;
    this->ki = ki;
...
void pidControllerPositional::solveDer(double* stateOld, double* stateNew, long long t, double dt, double* dStateOld,
                                       double* dStateNew)
{
    throw runtime_error(
        "void pidControllerPositional::solveDer(double *stateOld, double *stateNew, long long t, double dt, double "
