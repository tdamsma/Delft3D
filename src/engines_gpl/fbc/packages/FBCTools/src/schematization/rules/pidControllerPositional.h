...
#pragma once
#ifndef PIDPOSITIONAL_CONTROLLER_H
    #define PIDPOSITIONAL_CONTROLLER_H
...
namespace rtctools
{
    namespace schematization
    {
        namespace rules
        {
             ...
             */
            class pidControllerPositional : public rule
            {
            private:
                /**
            ...
            public:
                 ...
                 */
                pidControllerPositional(string id, string name, double p, double i, double d, double f,
...
#endif // PIDPOSITIONAL_CONTROLLER_H
