...
#pragma once
#ifndef PIDVELOCITY_CONTROLLER_H
    #define PIDVELOCITY_CONTROLLER_H
...
namespace rtctools
{
    namespace schematization
    {
        namespace rules
        {
             ...
             */
            class pidControllerVelocity : public rule
            {
            private:
                /**
            ...
            public:
                 ...
                 */
                pidControllerVelocity(string id, string name, double p, double i, double d, double f, double settingMin,
                                      double settingMax, double settingMaxSpeed, int iXIn, int iSPIn, int iFIn,
                                      int iYOut, int iIOut, int iDOut, int numSeries);
                pidControllerVelocity(string id, string name, double p, double i, double d, double f, double settingMin,
                                      double settingMax, double settingMaxSpeed, int iXIn, double SPIn, int iFIn,
                                      int iYOut, int iIOut, int iDOut, int numSeries);
                ~pidControllerVelocity(void);
...
#endif // PIDVELOCITY_CONTROLLER_H
