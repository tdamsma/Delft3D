...
pidController::pidController(string id, string name, double kp, double ki, double kd, double kf, double settingMin,
...
void pidController::solveDer(double* stateOld, double* stateNew, long long t, double dt, double* dStateOld,
                             double* dStateNew)
{
    throw runtime_error(
        "void pidController::solveDer(double *stateOld, double *stateNew, long long t, double dt, double *dStateOld, "
        "double *dStateNew) not implemented");
}
