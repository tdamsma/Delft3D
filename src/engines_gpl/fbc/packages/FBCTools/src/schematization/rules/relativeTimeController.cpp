...
relativeTimeController::relativeTimeController(string id, string name, lookupTableConverter* converter,
                                               valueOption vOpt, double tMaximum, int iYIn, int iYOut,
                                               int iTimeActiveOut, ruleMode vRuleMode)
    : rule(id, name)
{
    ...
    ruleCanBeActivatedForFirstTime =
        true; // when this becomes false it means the rule has been activated in the current run
...
void relativeTimeController::solveDer(double* stateOld, double* stateNew, long long t, double dt, double* dStateOld,
                                      double* dStateNew)
{
    throw runtime_error(
        "void relativeTimeController::solveDer(double *stateOld, double *stateNew, long long t, double dt, double "
