...
lookupTable::lookupTable(string id, string name, converter* conv, int iXIn, int iYIn, int iYOut)
...
void lookupTable::solveDer(double* stateOld, double* stateNew, long long t, double dt, double* dStateOld,
                           double* dStateNew)
{
    if (stateNew != 0)
    {
