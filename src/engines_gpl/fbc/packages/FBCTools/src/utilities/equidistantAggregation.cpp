...
equidistantAggregation::equidistantAggregation(interpolationOption intOpt, int nStep)
{
    this->intOpt = intOpt;
    this->nStep = nStep;
}

void equidistantAggregation::deaggregate(std::vector<double>& smallArray, double large0,
...
void equidistantAggregation::aggregate(std::vector<double>& largeArray, std::vector<double>& smallArray,
                                       bool accumulative)
{
    int nLarge = (int)largeArray.size();
    int nSmall = (int)smallArray.size();
