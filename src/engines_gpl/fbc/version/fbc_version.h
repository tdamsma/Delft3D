...
static char rtctools_version_id[] = {"@(#)Deltares, " PRODUCT_NAME " Version " OSS_Version "." OSS_Revision
                                     " (Win64), " __DATE__ ", " __TIME__ ""};
