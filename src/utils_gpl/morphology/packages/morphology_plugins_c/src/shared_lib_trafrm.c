 ...
 */
#if defined(WIN32)
long STDCALL PERFORM_FUNCTION_EQTRAN(long long int* sharedDLLHandle, char* function, long* dll_integers,
                                     long* max_integers, double* dll_reals, long* max_reals, char* dll_strings,
                                     long* max_strings, long* sbc_total, double* sbc, double* sbcu, double* sbcv,
                                     double* sbwu, double* sbwv, long* equi_conc, double* cesus, double* ssus,
                                     double* sswu, double* sswv, double* t_relax, char* message, long length_function,
                                     long length_dll_strings)
// message is a c-string: no length specification added
#elif defined(salford32)
extern "C" PERFORM_FUNCTION_EQTRAN(long* sharedDLLHandle, char* function, long* dll_integers, long* max_integers,
                                   double* dll_reals, long* max_reals, char* dll_strings, long* max_strings,
                                   long* sbc_total, double* sbc, double* sbcu, double* sbcv, double* sbwu, double* sbwv,
...
long STDCALL PERFORM_FUNCTION_EQTRAN(long* sharedDLLHandle, char* function, long* dll_integers, long* max_integers,
                                     ...
                                     double* sbwv, long* equi_conc, double* cesus, double* ssus, double* sswu,
                                     double* sswv, double* t_relax, char* message, long length_function,
                                     long length_dll_strings)
// message is a c-string: no length specification added
#endif
{
 ...
 */
#if defined(WIN32)
long STDCALL PERFORM_FUNCTION_EROSILT(long long int* sharedDLLHandle, char* function, long* dll_integers,
                                      long* max_integers, double* dll_reals, long* max_reals, char* dll_strings,
                                      long* max_strings, double* sink, double* source, char* message,
                                      long length_function, long length_dll_strings)
// message is a c-string: no length specification added
#elif defined(salford32)
extern "C" PERFORM_FUNCTION_EROSILT(long* sharedDLLHandle, char* function, long* dll_integers, long* max_integers,
                                    double* dll_reals, long* max_reals, char* dll_strings, long* max_strings,
