...
int APIENTRY RobElementsetAdd(const char* modelID, const char* elementsetID, const char* elementsetDescription,
...
int APIENTRY RobElementsetAddIDBasedMultiple(const char* modelID, const char* elementsetID,
...
/// <param name="elementsetDescription">elementset description string</param>
/// <param name="elementIDs">element identification strings</param>
int APIENTRY RobElementsetAddIDBasedSingle(const char* modelID, const char* elementsetID,
...
int APIENTRY RobElementsetGetInfo(const char* modelID, const char* elementsetID, char* elementsetDescription,
                                  ELEMENTSETTYPE* elementsetType, int* elementCount)
{
    RobElementsetPntr p;
