...
// $HeadURL:
// https://svn.oss.deltares.nl/repos/delft3d/branches/research/Deltares/20110420_OnlineVisualisation/src/utils_lgpl/d_hydro_lib/include/d_hydro.h
// $
//------------------------------------------------------------------------------
...
public:
    DeltaresHydro(int argc, char* argv[], char* envp[]);
...
public:
    ...
    Component*
        startComponent; // contains the resulting pointer to the dll entries after calling the component constructor
