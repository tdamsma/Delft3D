...
// $HeadURL:
// https://svn.oss.deltares.nl/repos/delft3d/branches/research/Deltares/20110420_OnlineVisualisation/src/utils_lgpl/d_hydro_lib/packages/d_hydro_lib/src/stringutils.cpp
// $
//------------------------------------------------------------------------------
//  d_hydro
...
#define IS_WHITESPACE(C) ((C) == '\f' || (C) == '\r' || (C) == '\t' || (C) == '\v' || (C) == ' ')
// newlines are not considered whitespace here

//------------------------------------------------------------------------------

void String::Chomp(char* string)
{
...
void String::CollapseAllWhitespace(char* string)
{
