...
//  Debugging Support
    ...
    #define FSM_DEBUG(X)                                                                                      \
        {                                                                                                     \
            ...
            {                                                                                                 \
                FILE* output =                                                                                \
                    (thid < 0 || FSM.Threads[thid].tracefile == NULL) ? stdout : FSM.Threads[thid].tracefile; \
...
static const char* fsm_type_name[] = {
    // note: must correspond with enum
    "", "integer", "real", "double prec", "double comp", "complex", "logical", "character",
};
