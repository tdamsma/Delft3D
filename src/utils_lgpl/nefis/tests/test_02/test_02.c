...
int main()
{
    ...
    */
    ...
    error = Defelm(&fd_nefis, elm_name, elm_type, elm_single_byte, elm_quantity, elm_unity, elm_desc, elm_num_dim,
                   elm_dimens);
    if (error != 0)
    {
        error = Neferr(1, error_string);
    ...
    error = Defgrp(&fd_nefis, grp_name, cel_names, grp_num_dim, grp_dimens, grp_order);
    if (error != 0)
    {
        error = Neferr(1, error_string);
        return 0;
    ...
    error = Putelt(&fd_nefis, grp_name, elm_name, (BInt4*)usr_index, usr_order, (BData)zeta4);
    if (error != 0)
    {
        error = Neferr(1, error_string);
        return 0;
    ...
    error = Putelt(&fd_nefis, grp_name, elm_name, (BInt4*)usr_index, usr_order, (BData)zeta8);
    if (error != 0)
    {
        error = Neferr(1, error_string);
        return 0;
    ...
    error = Putelt(&fd_nefis, grp_name, elm_name, (BInt4*)usr_index, usr_order, (BData)getal2);
    if (error != 0)
    {
        error = Neferr(1, error_string);
        return 0;
    ...
    error = Putelt(&fd_nefis, grp_name, elm_name, (BInt4*)usr_index, usr_order, (BData)getal4);
    if (error != 0)
    {
        error = Neferr(1, error_string);
        return 0;
    ...
    error = Putelt(&fd_nefis, grp_name, elm_name, (BInt4*)usr_index, usr_order, (BData)logical2);
    if (error != 0)
    {
        error = Neferr(1, error_string);
        return 0;
    ...
    error = Putelt(&fd_nefis, grp_name, elm_name, (BInt4*)usr_index, usr_order, (BData)logical4);
    if (error != 0)
    {
        error = Neferr(1, error_string);
        return 0;
    ...
    error = Putelt(&fd_nefis, grp_name, elm_name, (BInt4*)usr_index, usr_order, (BData)namst[0]);
    for (jj = 0; jj < 11; jj++)
    {
    ...
    error = Putelt(&fd_nefis, grp_name, elm_name, (BInt4*)usr_index, usr_order, (BData)cmplx8);
    if (error != 0)
    {
        error = Neferr(1, error_string);
        return 0;
    ...
    error = Putelt(&fd_nefis, grp_name, elm_name, (BInt4*)usr_index, usr_order, (BData)cmplx16);
    if (error != 0)
    {
        error = Neferr(1, error_string);
        return 0;
    ...
    usr_order[0] = 1;
    jj = 44;
    error = Getelt(&fd_nefis, grp_name, elm_name, (BInt4*)usr_index, usr_order, &jj, (BData)zeta4);
    ...
    usr_order[0] = 1;
    jj = 88;
    error = Getelt(&fd_nefis, grp_name, elm_name, (BInt4*)usr_index, usr_order, &jj, (BData)zeta8);
    ...
    usr_order[0] = 1;
    jj = 22;
    error = Getelt(&fd_nefis, grp_name, elm_name, (BInt4*)usr_index, usr_order, &jj, (BData)getal2);
    ...
    usr_order[0] = 1;
    jj = 44;
    error = Getelt(&fd_nefis, grp_name, elm_name, (BInt4*)usr_index, usr_order, &jj, (BData)getal4);
    ...
    usr_order[0] = 1;
    jj = 22;
    error = Getelt(&fd_nefis, grp_name, elm_name, (BInt4*)usr_index, usr_order, &jj, (BData)logical2);
    ...
    usr_order[0] = 1;
    jj = 44;
    error = Getelt(&fd_nefis, grp_name, elm_name, (BInt4*)usr_index, usr_order, &jj, (BData)logical4);
    ...
    usr_order[0] = 1;
    jj = 231;
    error = Getelt(&fd_nefis, grp_name, elm_name, (BInt4*)usr_index, usr_order, &jj, (BData)namstat);
    ...
    usr_order[0] = 1;
    jj = 88;
    error = Getelt(&fd_nefis, grp_name, elm_name, (BInt4*)usr_index, usr_order, &jj, (BData)cmplx8);
    ...
    usr_order[0] = 1;
    jj = 176;
    error = Getelt(&fd_nefis, grp_name, elm_name, (BInt4*)usr_index, usr_order, &jj, (BData)cmplx16);
