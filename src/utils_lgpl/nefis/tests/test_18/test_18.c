...
int main()
{
    ...
    for (i = 0; i < 6; i++)
    {
        if (error == 0)
        {
            ...
            error = Putelt(&fd_nefis, grp_name, elm_name, (BInt4*)usr_index, usr_order, (BVoid*)getal);
        }
    }
    ...
    for (i = 0; i < 2; i++)
    {
        if (error == 0)
        {
            ...
            error = Putelt(&fd_nefis, grp_name, elm_name, (BInt4*)usr_index, usr_order, (BVoid*)zeta);
        }
    }
    ...
    for (i = 0; i < 13; i++)
    {
        if (error == 0)
        {
            ...
            error = Putelt(&fd_nefis, grp_name, elm_name, (BInt4*)usr_index, usr_order, (BVoid*)namst);
        }
    }
    ...
    for (i = 0; i < 2; i++)
    {
        if (error == 0)
        {
            ...
            error = Getelt(&fd_nefis, grp_name, elm_name, (BUInt4*)usr_index, usr_order, &buf_len, (BData)getallen);
    ...
    for (i = 0; i < 2; i++)
    {
        if (error == 0)
        {
            ...
            error = Getelt(&fd_nefis, grp_name, elm_name, (BUInt4*)usr_index, usr_order, &buf_len, (BData)zetaa);
    ...
    for (i = 0; i < 13; i++)
    {
        if (error == 0)
        {
            ...
            error = Getelt(&fd_nefis, grp_name, elm_name, (BUInt4*)usr_index, usr_order, &buf_len, (BData)namstat);
            ...
            for (mm = 0; mm < 5; mm++)
            {
                for (ll = 0; ll < 3; ll++)
                {
                    for (jj = 0; jj < 4; jj++)
                    {
                        ...
                        {
                            zeta[kk + 6 * jj + 6 * 4 * ll + 6 * 4 * 3 * mm + 6 * 4 * 3 * 5 * nn] =
                                (BRea4)(100 * (i + 1 + 7) + 1000 * (mm + 1) + 10000 * (ll + 1) + 10 * (jj + 1) + kk +
                                        1);
                        }
                    }
                }
