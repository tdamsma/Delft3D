...
BInt4 Define_element(BInt4, BText, BText, BText, BText, BText, BInt4, BInt4, BInt4*);
BInt4 Define_group(BInt4, BText, BText, BInt4, BInt4*, BInt4*);
BInt4 Get_element(BInt4, BText, BText, BInt4*, BInt4*, BUInt4, BData);
BInt4 GP_flush_hash(BInt4, BInt4);
BInt4 GP_get_next_cell(BInt4, BInt4, BText, BText*, BUInt4*, BUInt8*);
BInt4 GP_get_next_elm(BInt4, BInt4, BText, BText, BText, BText, BText, BUInt4*, BUInt4*, BUInt4*, BUInt8*);
BInt4 GP_get_next_def_grp(BInt4, BInt4, BText, BText, BInt4*, BInt4*, BInt4*);
BInt4 GP_get_next_grp(BInt4, BInt4, BText, BText);
BInt4 GP_get_attribute(BInt4, BInt4, BText, BText, BData, BText);
BInt4 GP_inquire_cel(BInt4, BText, BUInt4*, BText*, BUInt8*);
BInt4 GP_inquire_dat(BInt4, BUInt8*, BText, BText);
BInt4 GP_inquire_elm(BInt4, BText, BText, BText, BText, BText, BUInt4*, BUInt4*, BUInt4*, BUInt8*);
BInt4 GP_inquire_grp_def(BInt4, BText, BText, BUInt4*, BUInt4*, BUInt4*);
...
BInt4 Put_element(BInt4, BText, BText, BInt4*, BInt4*, BData);
