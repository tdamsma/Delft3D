...
extern DLLEXPORT BInt4 Crenef(BInt4*, BText, BText, BChar, BChar);
...
extern DLLEXPORT BInt4 Defelm(BInt4*, BText, BText, BInt4, BText, BText, BText, BInt4, BInt4*);
extern DLLEXPORT BInt4 Defgrp(BInt4*, BText, BText, BInt4, BInt4*, BInt4*);
extern DLLEXPORT BInt4 Flsdat(BInt4*);
extern DLLEXPORT BInt4 Flsdef(BInt4*);
extern DLLEXPORT BInt4 Getelt(BInt4*, BText, BText, BInt4*, BInt4*, BInt4*, BData);
...
extern DLLEXPORT BInt4 Inqelm(BInt4*, BText, BText, BInt4*, BText, BText, BText, BInt4*, BInt4*);
...
extern DLLEXPORT BInt4 Inqfel(BInt4*, BText, BText, BText, BText, BText, BInt4*, BInt4*, BInt4*, BInt4*);
extern DLLEXPORT BInt4 Inqnel(BInt4*, BText, BText, BText, BText, BText, BInt4*, BInt4*, BInt4*, BInt4*);
