...
static DioShmPart fPart2Cpp(int* fDataPart) { return ((*fDataPart == 0) ? DioShmHeaderPart : DioShmDataPart); }
...
static void textF2C(char* name, int nameLen, char* locName)
{
    char* p;
...
//
static void nameToLower(char* name)
{
    char* p;
    for (p = name; *p != '\0'; p++)
...
//
void STDCALL DIO_SHM_F2C_DS_DESTROY_C(long long int* cHandle) { delete ((DioShmDs*)*cHandle); }
...
//
void STDCALL DIO_SHM_F2C_DS_SETSIZEPART_C(int* retVal, long long int* cHandle, int* dataPart, int* size)
{
...
//
void STDCALL DIO_SHM_F2C_START_WRITE_C(long long int* cHandle, int* dataPart, int* retVal)
{
    *retVal = ((DioShmDs*)*cHandle)->StartWrite(fPart2Cpp(dataPart));
}

void STDCALL DIO_SHM_F2C_END_WRITE_C(long long int* cHandle, int* dataPart)
{
    ((DioShmDs*)*cHandle)->EndWrite(fPart2Cpp(dataPart));
}

void STDCALL DIO_SHM_F2C_START_READ_C(long long int* cHandle, int* dataPart, int* retVal)
{
    *retVal = ((DioShmDs*)*cHandle)->StartRead(fPart2Cpp(dataPart));
}

void STDCALL DIO_SHM_F2C_END_READ_C(long long int* cHandle, int* dataPart)
{
...
//
void STDCALL DIO_SHM_F2C_DS_WRITE_REALS_C(long long int* cHandle, int* dataPart, int* nReals, float* reals)
{
    ((DioShmDs*)*cHandle)->Write(fPart2Cpp(dataPart), (*nReals) * sizeof(float), (char*)reals);
}

void STDCALL DIO_SHM_F2C_DS_WRITE_DOUBLES_C(long long int* cHandle, int* dataPart, int* nDoubles, double* doubles)
{
    ((DioShmDs*)*cHandle)->Write(fPart2Cpp(dataPart), (*nDoubles) * sizeof(double), (char*)doubles);
}

void STDCALL DIO_SHM_F2C_DS_WRITE_INTS_C(long long int* cHandle, int* dataPart, int* nInts, int* ints)
{
    ((DioShmDs*)*cHandle)->Write(fPart2Cpp(dataPart), (*nInts) * sizeof(int), (char*)ints);
}

void STDCALL DIO_SHM_F2C_DS_WRITE_INT_C(long long int* cHandle, int* dataPart, int* integer)
{
    ((DioShmDs*)*cHandle)->Write(fPart2Cpp(dataPart), sizeof(int), (char*)integer);
}

void STDCALL DIO_SHM_F2C_DS_WRITE_CHARS_C(long long int* cHandle, int* dataPart, int* nChars, char* chars, int charsLen)
{
...
//
int STDCALL DIO_SHM_F2C_DS_READ_REALS_C(long long int* cHandle, int* dataPart, int* nReals, float* reals)
{
    return ((DioShmDs*)*cHandle)->Read(fPart2Cpp(dataPart), (*nReals) * sizeof(float), (char*)reals);
}

int STDCALL DIO_SHM_F2C_DS_READ_DOUBLES_C(long long int* cHandle, int* dataPart, int* nDoubles, double* doubles)
{
    return ((DioShmDs*)*cHandle)->Read(fPart2Cpp(dataPart), (*nDoubles) * sizeof(double), (char*)doubles);
}

int STDCALL DIO_SHM_F2C_DS_READ_INTS_C(long long int* cHandle, int* dataPart, int* nInts, int* ints)
{
    return ((DioShmDs*)*cHandle)->Read(fPart2Cpp(dataPart), (*nInts) * sizeof(int), (char*)ints);
}

int STDCALL DIO_SHM_F2C_DS_READ_INT_C(long long int* cHandle, int* dataPart, int* integer)
{
    return ((DioShmDs*)*cHandle)->Read(fPart2Cpp(dataPart), sizeof(int), (char*)integer);
}

int STDCALL DIO_SHM_F2C_DS_READ_CHARS_C(long long int* cHandle, int* dataPart, int* nChars, char* chars, int charsLen)
{
...
void STDCALL DIO_SHM_F2C_PUTDB_DOUBLES_C(int* nDoubles, double* doubles, char* name, int nameLen)
{
    char locName[MAX_DS_NAME_LEN + 1];
...
void STDCALL DIO_SHM_F2C_GETDB_DOUBLES_C(int* retVal, int* nDoubles, double* doubles, char* name, int nameLen)
{
    char locName[MAX_DS_NAME_LEN + 1];
...
void STDCALL DIO_SHM_F2C_FREEDB_C(char* name, int nameLen)
{
    char locName[MAX_DS_NAME_LEN + 1];
...
void STDCALL DIO_SHM_F2C_DBCLEANUP_C(void) { DioShmDataBlockCleanup(); }
