...
DllProcedureAddress GetDllProcedure(int64_t* sharedDLLHandle, char* fun_name)
{
...
long STDCALL BMI_INITIALIZE(int64_t* sharedDLLHandle, char* config_file, int config_file_len)
{
...
void STDCALL BMI_GET_START_TIME(int64_t* sharedDLLHandle, double* start_time)
{
    *start_time = DllGetBmiTime(sharedDLLHandle, "get_start_time");
}

void STDCALL BMI_GET_END_TIME(int64_t* sharedDLLHandle, double* end_time)
{
    *end_time = DllGetBmiTime(sharedDLLHandle, "get_end_time");
}

void STDCALL BMI_GET_CURRENT_TIME(int64_t* sharedDLLHandle, double* current_time)
{
    *current_time = DllGetBmiTime(sharedDLLHandle, "get_current_time");
}

void STDCALL BMI_GET_TIME_STEP(int64_t* sharedDLLHandle, double* time_step)
{
    *time_step = DllGetBmiTime(sharedDLLHandle, "get_time_step");
}

void STDCALL BMI_GET_VAR(int64_t* sharedDLLHandle, char* var_name, double* values, int* num_values, int var_name_len)
{
...
void STDCALL BMI_SET_VAR(int64_t* sharedDLLHandle, char* var_name, double* values, int* num_values, int var_name_len)
{
    typedef void*(STDCALL * MyProc)(char*, double*);
...
long STDCALL BMI_UPDATE(int64_t* sharedDLLHandle, double* dt)
{
    typedef void*(STDCALL * MyProc)(double);
